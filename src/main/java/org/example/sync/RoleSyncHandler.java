...
public class RoleSyncHandler extends SyncHandler {
    public RoleSyncHandler(Properties config, String entityType, SnowClient snowClient, String pingAccessToken, Boolean testmode) {
        super(config, "role", snowClient, pingAccessToken, testmode);
    }

    @Override
    public void sync() throws Exception {
        logger.debug("Syncing roles...");
        executeSync();
    }

    @Override
    protected String getQueryTemplate() {
        return config.getProperty("ping.tenant.url")+ config.getProperty("ping.role.query");
    }

    @Override
    protected String getQueryBody() {
        return config.getProperty("ping.role.query.body");
    }

    @Override
    protected String getMapping() {
        return config.getProperty("snow.role.catalog.mapping");
    }

    @Override
    protected String getCreateTemplate() {
        return config.getProperty("snow.role.create.template");
    }
