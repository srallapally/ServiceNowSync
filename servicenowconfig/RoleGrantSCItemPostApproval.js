try {
    ...
    var requestTypeId = gs.getProperty("ping.role.request_type");
    var workflowId = gs.getProperty("ping.role.workflowid");
    ...
    gs.log("Getting Comments for "+current.sys_id,"Ping RITM Post Approval Info");
    ...
    while (apv.next()) { // Go through all approvals with comments
        ...
        gs.log("Comments for "+current.sys_id,"Ping RITM Post Approval Info");
        ...
        while(commentGr.next()){
            ...
            gs.log("Comments for "+approverHistory,"Ping RITM Post Approval Info");
        }
